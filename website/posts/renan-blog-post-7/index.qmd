...
Run your preprocessed dataset (project dataset) on WEKA and find the association rules using the Apriori algorithm.  

Present at least 10 valid association rules and give an interpretation of the association rules. 

Interpretation of your results should include the support and confidence values you used and an interpretation of the support and confidence values.
